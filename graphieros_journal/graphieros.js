(function main() {
    ...
    (function process_text_to_glyphs() {
        ...
        for (let i = 0; i < graphieros_text.length; i += 1) {
            ...
            svg_paragraph.setAttributeNS(null, "viewBox", "0 0 260 1000");
            svg_paragraph.style.width = "50px";
            ...
            for (let j = 0; j < one_array_with_spaces.length; j += 1) {
                console.log(one_array_with_spaces[j]);
            ...
            console.log(rebuilt_glyphs_library);

            rebuilt_glyphs_library.forEach(glyph_array => {

                glyph_array.forEach(glyph => {
